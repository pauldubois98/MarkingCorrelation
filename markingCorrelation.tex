...
\begin{document}
	...
	We used the Kaggles challenges as an unbiased evaluation method.
	While a teacher could be more interested (for personal reasons) in one project rather than another, we consider that the five Kaggle challenges create a representative metric on the students capacities.
	Thus, we consider the average score on the Kaggles competitions as the "ground truth" of what students should get as a grade.
	Of course, one can always imagine that some students spent much more time and energy on the project than on the Kaggles, but such consideration are outside the scope of this article.
